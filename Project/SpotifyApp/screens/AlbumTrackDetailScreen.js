...
//     albumType,
//   } = route.params;
//    // Dữ liệu mẫu cho hai FlatList mới
//    const moreByArtistData = [
//     {
//       id: '1',
//       title: 'Hikaru Utada SCIENCE FICTION T',
//       image: 'https://example.com/image1.jpg',
//       subtitle: 'Latest Release - Album'
//     },
//     {
//       id: '2',
//       title: 'First Love',
...
//     {
//       id: '1',
//       title: 'This is Hikaru Utada',
//       image: 'https://example.com/image4.jpg',
//       subtitle: 'The all-timers from Japanese pop super...'
//     },
//     {
//       id: '2',
//       title: 'City Pop',
//       image: 'https://example.com/image5.jpg',
//       subtitle: '再び脚光を浴びる日本のシティ・ポップの...'
//     },
//     {
//       id: '3',
//       title: 'J-Pop Hits',
//       image: 'https://example.com/image6.jpg',
//       subtitle: 'Enjoy the epic hits...'
//     }
//   ];
...
//   // console.log("AlbumDetailsScreen", colorDark)
...
//     // console.log("Album check artist: ",songIds)
//     const isLiked = songIds.includes(item.track_id); // Kiểm tra xem item.id có trong allSongIds không
...
const AlbumDetailsScreen = ({ route}) => {
  ...
  // console.log("AlbumDetailsScreen", moreAlbumsByArtist);
  // console.log("AlbumDetailsScreen", copyright);
  const [songIds, setSongIds] = useState([]);
  const [dominantColors, setDominantColors] = useState(null);
  const [isLoading, setIsLoading] = useState(true);
  const scrollY = new Animated.Value(0);
